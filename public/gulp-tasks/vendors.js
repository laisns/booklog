...
gulp.task('buildBaseVendorStyles', function() {
    return gulp.src(['./node_modules/perfect-scrollbar/stylesheets/perfect-scrollbar.stylesheets'])
      .pipe(concat('vendor.bundle.base.stylesheets'))
      .pipe(gulp.dest('./assets/vendors/stylesheets'));
});
...
gulp.task('buildOptionalVendorStyles', function() {
    var aStyle1 = gulp.src(['./node_modules/@mdi/font/stylesheets/materialdesignicons.min.stylesheets'])
        .pipe(gulp.dest('./assets/vendors/mdi/stylesheets'));
    var aStyle2 = gulp.src(['./node_modules/@mdi/font/fonts/*'])
        .pipe(gulp.dest('./assets/vendors/mdi/fonts'));
    var aStyle3 = gulp.src(['./node_modules/flag-icon-stylesheets/stylesheets/flag-icon.min.stylesheets'])
        .pipe(gulp.dest('./assets/vendors/flag-icon-stylesheets/stylesheets'));
    var aStyle4 = gulp.src(['./node_modules/flag-icon-stylesheets/flags/**/*'])
        .pipe(gulp.dest('./assets/vendors/flag-icon-stylesheets/flags'));
    var aStyle5 = gulp.src(['node_modules/select2/dist/stylesheets/select2.min.stylesheets'])
        .pipe(gulp.dest('./assets/vendors/select2')); 
    var aStyle6 = gulp.src(['node_modules/select2-bootstrap-theme/dist/select2-bootstrap.min.stylesheets'])
        .pipe(gulp.dest('./assets/vendors/select2-bootstrap-theme'));
    var aStyle7 = gulp.src(['node_modules/jvectormap/jquery-jvectormap.stylesheets'])
        .pipe(gulp.dest('./assets/vendors/jvectormap')); 
    var aStyle8 = gulp.src(['node_modules/owl.carousel/dist/assets/owl.carousel.min.stylesheets'])
        .pipe(gulp.dest('./assets/vendors/owl-carousel-2'));
    var aStyle9 = gulp.src(['node_modules/owl.carousel/dist/assets/owl.theme.default.min.stylesheets'])
        .pipe(gulp.dest('./assets/vendors/owl-carousel-2'));
    var aStyle10 = gulp.src(['node_modules/owl.carousel/dist/assets/owl.video.play.png'])
        .pipe(gulp.dest('./assets/vendors/owl-carousel-2'));
    var aStyle11 = gulp.src(['node_modules/codemirror/lib/codemirror.stylesheets'])
        .pipe(gulp.dest('./assets/vendors/codemirror'));
    var aStyle12 = gulp.src(['node_modules/codemirror/theme/ambiance.stylesheets'])
        .pipe(gulp.dest('./assets/vendors/codemirror'));
    var aStyle13 = gulp.src(['node_modules/pwstabs/assets/jquery.pwstabs.min.stylesheets'])
        .pipe(gulp.dest('./assets/vendors/pwstabs'));
...
gulp.task('copyMapFiles', function() {
    var map1 = gulp.src('node_modules/bootstrap/dist/js/bootstrap.min.js.map')
        .pipe(gulp.dest('./assets/vendors/js'));
    var map2 = gulp.src('node_modules/@mdi/font/stylesheets/materialdesignicons.min.stylesheets.map')
        .pipe(gulp.dest('./assets/vendors/mdi/stylesheets'));
